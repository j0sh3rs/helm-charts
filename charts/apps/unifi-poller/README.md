...
| https://library-charts.j0sh3rs.com | common | 4.5.2 |

## TL;DR

```console
helm repo add j0sh3rs https://j0sh3rs.com/charts/
helm repo update
helm install unifi-poller j0sh3rs/unifi-poller
```
...
Other values may be used from the [values.yaml](https://github.com/j0sh3rs/library-charts/tree/main/charts/library/common/values.yaml) from the [common library](https://github.com/j0sh3rs/library-charts/tree/main/charts/library/common).
...
helm install unifi-poller \
  --set env.TZ="America/New York" \
    j0sh3rs/unifi-poller
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install unifi-poller j0sh3rs/unifi-poller -f values.yaml
```
...
**Important**: When deploying an application Helm chart you can add more values from our common library chart [here](https://github.com/j0sh3rs/library-charts/tree/main/charts/library/common)
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/j0sh3rs/unifi-poller?modal=changelog)
